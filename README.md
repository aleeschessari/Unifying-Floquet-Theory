The data used to generate the figure in the paper are available in the data/ folder and may be plotted with the notebooks in plot/test. This repo uses QuTip 5.0.1 and cupy. if you do not have cupy you can import functions.function_nocuda instead of functions.function
